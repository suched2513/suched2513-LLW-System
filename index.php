...
$modules = [
    ...
    ['url'=>'edocument/index.php',             'icon'=>'bi-file-earmark-text-fill', 'bgIcon'=>'bi-file-earmark-medical',  'title'=>'ระบบงาน e-สารบรรณ',  'short'=>'e-สารบรรณ',  'desc'=>'ระบบจัดการเอกสารราชการอิเล็กทรอนิกส์ หนังสือรับ-ส่ง คำสั่ง และบันทึกข้อความ',     'color'=>'blue',   'gradient'=>'from-cyan-500 to-blue-500',      'delay'=>1.05],
    ['url'=>'school_project/homeroom/daily/log.php', 'icon'=>'bi-journal-check',  'bgIcon'=>'bi-journal-text',         'title'=>'บันทึกโฮมรูม',       'short'=>'โฮมรูม',    'desc'=>'บันทึกการเข้าแถว เช็คชื่อนักเรียนรายคน กิจกรรมประจำวัน พร้อมรายงานให้ผู้บริหาร', 'color'=>'amber',  'gradient'=>'from-amber-600 to-orange-500',   'delay'=>1.05],
