...
$modules = [
    ...
    ['url'=>'homeroom/index.php',              'icon'=>'bi-mortarboard-fill',    'bgIcon'=>'bi-mortarboard',          'title'=>'ระบบครูที่ปรึกษา',   'short'=>'ที่ปรึกษา', 'desc'=>'ศูนย์กลางการดูแลนักเรียนประจำชั้น ติดตามการเข้าแถว พฤติกรรม',                     'color'=>'indigo', 'gradient'=>'from-indigo-600 to-violet-700',  'delay'=>1.0],
