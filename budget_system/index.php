...
<div class="space-y-6">
    ...
    <div class="bg-navy p-8 rounded-[2.5rem] shadow-2xl flex flex-col md:flex-row justify-between items-center gap-6 relative overflow-hidden">
        ...
        <div class="flex gap-4 relative z-10">
            <a href="projects.php" class="bg-gold hover:bg-amber-600 text-navy px-8 py-3.5 rounded-2xl font-black shadow-xl shadow-gold/20 flex items-center gap-3 transition-all hover:scale-[1.05]">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <!-- Total Budget Card -->
        <div class="bg-navy rounded-[2.5rem] p-8 text-white shadow-2xl relative overflow-hidden group">
            ...
            <div class="relative z-10">
                <div class="w-14 h-14 bg-gold rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-gold/40">
                    <i class="bi bi-bank2 text-2xl text-navy"></i>
                </div>
                <p class="text-[10px] font-black uppercase tracking-[0.2em] text-gold/80">งบประมาณรวมทั้งปี</p>
                <h3 class="text-3xl font-black mt-2 tracking-tight">฿<?= number_format($totalBudget, 2) ?></h3>
        ...
        <div class="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-xl shadow-slate-200/40 relative overflow-hidden group">
            <div class="relative z-10">
                <div class="w-14 h-14 bg-slate-50 text-navy rounded-2xl flex items-center justify-center mb-6 group-hover:bg-navy group-hover:text-gold transition-all duration-500">
                ...
                <h3 class="text-3xl font-black text-navy mt-2">฿<?= number_format($totalUsed, 2) ?></h3>
                <div class="mt-6">
        ...
        <div class="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-xl shadow-slate-200/40 relative overflow-hidden group">
            <div class="relative z-10">
                <div class="w-14 h-14 bg-amber-50 text-gold rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                ...
                <h3 class="text-3xl font-black text-navy mt-2">12 <span class="text-base font-bold text-slate-300 ml-1">โครงการ</span></h3>
                <div class="mt-6 flex items-center gap-2">
        ...
        <div class="grid grid-rows-2 gap-4 h-full">
            <a href="projects.php" class="bg-gold hover:bg-amber-600 text-navy rounded-3xl p-5 flex items-center justify-between transition-all group shadow-lg shadow-gold/20">
                <div class="flex items-center gap-4">
                    <i class="bi bi-plus-circle-fill text-xl group-hover:rotate-90 transition-transform"></i>
                    <span class="text-xs font-black uppercase tracking-wider">ใหม่</span>
                </div>
                <i class="bi bi-arrow-right"></i>
            </a>
            <a href="disbursements.php" class="bg-navy hover:bg-slate-800 text-white rounded-3xl p-5 flex items-center justify-between transition-all group shadow-xl">
                <div class="flex items-center gap-4">
                    <i class="bi bi-receipt text-xl group-hover:scale-110 transition-transform"></i>
                    <span class="text-xs font-black uppercase tracking-wider">เบิกจ่าย</span>
                </div>
    ...
    <!-- Feature items from dashboard.html -->
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div class="bg-white/70 backdrop-blur-md p-5 rounded-3xl border border-slate-100 flex items-center gap-4 group hover:shadow-lg transition-all cursor-pointer">
            <div class="w-12 h-12 bg-navy text-gold rounded-2xl flex items-center justify-center text-xl group-hover:rotate-12 transition-transform">📊</div>
            <div>
                <p class="text-xs font-black text-navy">Dashboard</p>
                <p class="text-[9px] text-slate-400 font-bold uppercase tracking-widest">ข้อมูลแบบเรียลไทม์</p>
            </div>
        </div>
        <div class="bg-white/70 backdrop-blur-md p-5 rounded-3xl border border-slate-100 flex items-center gap-4 group hover:shadow-lg transition-all cursor-pointer">
            <div class="w-12 h-12 bg-navy text-gold rounded-2xl flex items-center justify-center text-xl group-hover:rotate-12 transition-transform">🏗️</div>
            <div>
                <p class="text-xs font-black text-navy">Procurement</p>
                <p class="text-[9px] text-slate-400 font-bold uppercase tracking-widest">ระบบจัดซื้อจัดจ้าง</p>
            </div>
        </div>
        <div class="bg-white/70 backdrop-blur-md p-5 rounded-3xl border border-slate-100 flex items-center gap-4 group hover:shadow-lg transition-all cursor-pointer">
            <div class="w-12 h-12 bg-navy text-gold rounded-2xl flex items-center justify-center text-xl group-hover:rotate-12 transition-transform">📖</div>
            <div>
                <p class="text-xs font-black text-navy">Cashbook</p>
                <p class="text-[9px] text-slate-400 font-bold uppercase tracking-widest">ทะเบียนเงินนอก/ใน</p>
            </div>
        </div>
        <div class="bg-white/70 backdrop-blur-md p-5 rounded-3xl border border-slate-100 flex items-center gap-4 group hover:shadow-lg transition-all cursor-pointer">
            <div class="w-12 h-12 bg-navy text-gold rounded-2xl flex items-center justify-center text-xl group-hover:rotate-12 transition-transform">📄</div>
            <div>
                <p class="text-xs font-black text-navy">Reports</p>
                <p class="text-[9px] text-slate-400 font-bold uppercase tracking-widest">รายงาน สตง. / สพฐ.</p>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <!-- Main Chart Area -->
        <div class="lg:col-span-2 bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-xl">
            ...
            <div class="h-80 flex items-center justify-center bg-slate-50/50 rounded-3xl border border-dashed border-slate-200">
                <div class="text-center">
                    <i class="bi bi-graph-up text-5xl text-slate-200"></i>
                    <p class="text-xs text-slate-400 mt-4 font-black uppercase tracking-widest">Chart Visualization Rendering...</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-xl">
            ...
            <div class="space-y-6">
                ...
                <div>
                    <div class="flex justify-between items-center mb-2">
                        <span class="text-xs font-black text-slate-700"><?= htmlspecialchars($src['plan_name']) ?></span>
                ...
                <div class="mt-8 p-6 bg-navy text-white rounded-3xl relative overflow-hidden">
                    ...
                    <p class="text-2xl font-black text-gold tracking-tight">฿<?= number_format($remaining, 2) ?></p>
                </div>
            </div>
        </div>
    </div>
