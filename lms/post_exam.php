...
<div class="bg-white rounded-2xl shadow-xl shadow-slate-100/50 border border-slate-100 overflow-hidden">
  <table class="w-full text-sm">
    ...
    <tbody class="divide-y divide-slate-50">
      ...
      <tr><td colspan="4" class="py-16 text-center text-slate-300"><i class="fas fa-clipboard-check text-4xl mb-3 block opacity-30"></i>ยังไม่มีข้อสอบ</td></tr>
      <?php endif; ?>
  ...
  <div class="bg-white rounded-2xl shadow-2xl w-full max-w-xl max-h-[90vh] overflow-y-auto">
    ...
    <form method="POST" class="p-6 space-y-4">
      ...
      <div>
        ...
        <input type="text" name="choice<?=$n?>" id="<?=$mid?>_pc<?=$n?>" required class="w-full border border-slate-200 rounded-xl px-3 py-2 text-sm focus:ring-2 focus:ring-rose-400 outline-none">
      </div>
      <?php endfor; ?>
      <div>
