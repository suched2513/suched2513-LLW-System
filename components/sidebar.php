...
elseif (strpos($full_url, '/lms/') !== false || strpos($full_url, '/lms_system/') !== false) $activeSystem = 'lms';
...
$subMenus = [
    ...
    'lms' => [
        ['icon' => 'fas fa-tachometer-alt',    'label' => 'Dashboard LMS',       'url' => $base_path . '/lms/dashboard.php', 'roles' => ['super_admin','att_teacher']],
        ['icon' => 'fas fa-chalkboard',        'label' => 'วิชาของฉัน',           'url' => $base_path . '/lms/subjects.php', 'roles' => ['super_admin','att_teacher']],
        ['icon' => 'fas fa-folder-open',       'label' => 'จัดการหน่วย & ข้อสอบ',  'url' => $base_path . '/lms_system/manage_units.php', 'roles' => ['super_admin','att_teacher']],
        ['icon' => 'fas fa-chart-bar',         'label' => 'รายงานผลสอบ Quiz',     'url' => $base_path . '/lms_system/quiz_reports.php', 'roles' => ['super_admin','att_teacher']],
        ['icon' => 'fas fa-edit',              'label' => 'แบบทดสอบของฉัน (Quiz)', 'url' => $base_path . '/lms_system/student_quizzes.php', 'roles' => ['student','wfh_staff','super_admin']],
        ['icon' => 'fas fa-plus-square',       'label' => 'สั่งงาน (การบ้าน)',      'url' => $base_path . '/lms/assign_work.php', 'roles' => ['super_admin','att_teacher']],
    ...
    <div class="sidebar-wrapper">
        <nav class="mt-2">
            <ul class="nav sidebar-menu flex-column" data-lte-toggle="treeview" role="menu" data-accordion="true">
                ...
                <?php if (in_array($userRole, ['super_admin', 'att_teacher', 'student', 'wfh_staff'])): ?>
                <!-- LMS -->
                <li class="nav-item <?= $activeSystem === 'lms' ? 'menu-open' : '' ?>">
                    <a href="#" class="nav-link <?= $activeSystem === 'lms' ? 'active' : '' ?>">
                        ...
                        <p style="color:<?= $activeSystem === 'lms' ? '#fff' : '#c4b5fd' ?>">ระบบ LMS / สอบออนไลน์ <i class="nav-arrow fas fa-angle-left"></i></p>
                    </a>
                    <ul class="nav nav-treeview">
    ...
    <div class="sidebar-footer p-3">
        <div class="d-flex align-items-center gap-2 mb-2">
            ...
            <div style="overflow:hidden;flex:1;">
                <div style="font-size:0.75rem;font-weight:700;color:#f1f5f9;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:140px;">
