...
$stmt = $pdo->prepare("SELECT exercise_id, answer_text, file_paths, link_url, grade, feedback, reviewed_at, submitted_at FROM lms_student_exercises WHERE student_uid=? AND subject_id=?");
