...
<div class="group-section" data-unit="<?=$g['unit']['id']?>">
  ...
  <div class="assignment-card bg-white rounded-2xl border-2 p-4 shadow-sm"
    ...
    <?php if ($reviewed): ?>
    <?php
      $qmap_s = ['น่าชื่นชมมาก!ครับ'=>'bg-violet-100 text-violet-700','ทำได้ดีมาก!ครับ'=>'bg-blue-100 text-blue-700','ดีขึ้นเรื่อยๆ เลย!ครับ'=>'bg-emerald-100 text-emerald-700','สู้ๆ ครูเชื่อในตัวเธอครับ'=>'bg-amber-100 text-amber-700','อย่าท้อ ลองใหม่นะครับ'=>'bg-rose-100 text-rose-700'];
      $qval_s = $sub['quality'] ?? '';
    ?>
