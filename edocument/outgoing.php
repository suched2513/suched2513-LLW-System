<?php
/**
 * edocument/outgoing.php
 * หนังสือส่ง (Outgoing Documents)
 */
session_start();
...
function editDoc(id) {
    $.ajax({
        ...
        type: 'GET',
        data: { action: 'get', type: 'outgoing', id: id },
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: '../ajax/documents.php',
                type: 'POST',
                data: { action: 'delete', type: 'outgoing', id: id },
                success: function(res) {
                    if (res.success) {
