...
$migrationName = '2026_05_03_000001_create_club_tables';
$migrationFile = __DIR__ . '/../database/migrations/' . $migrationName . '.php';

$steps = [
    'สร้างตาราง club_* (ระบบชุมนุม)' => function (PDO $pdo) use ($migrationFile, $migrationName) {
        // Skip if already run
        try {
...
?><!DOCTYPE html>
<html lang="th"><head><meta charset="UTF-8"><title>Migration — ระบบชุมนุม</title>
<style>
...
<h2>Migration Results — ระบบชุมนุม</h2>
...
<?php endif; ?>
<p>
  <a href="/club/index.php">→ ไปที่ระบบชุมนุม</a>
  &nbsp;|&nbsp;
