...
hrRenderHead($pageTitle);
echo '<div class="d-flex">'; hrRenderSidebar('/homeroom/reports/list.php'); echo '<div class="main-content flex-grow-1">'; hrRenderTopbar($pageTitle); echo '<div class="page-content">'; hrShowFlash();
?>
